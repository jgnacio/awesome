...
-- beautiful.init(gears.filesystem.get_themes_dir() .. "gtk/theme.lua") OLDCONFIG
...
--## WALLPAPER ##--
gears.wallpaper.maximized("/home/jgit/Pictures/wallpaper/wallpaper.jpg", s)
--## AUTO START ##--
...
-- })
-- start gmail
-- awful.spawn("firefox \\https://gmail.com", {
--	tag = "",
-- })
-- start spotify
